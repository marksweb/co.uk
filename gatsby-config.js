    ...
    `gatsby-plugin-styled-components`,
    {
      ...
      options: {
        ...
        directives: {
          ...
          'default-src': `'self'`,
          'connect-src': `'self' data: www.google-analytics.com sentry.io *.sentry.io`,
        },
      },
    },
      ...
      options: {
        headers: {
          '/*': [
            ...
            // That is handled by the build script which executes csp-util.mjs, which looks for the token below.
            'Content-Security-Policy: __REPLACE_ME__',
            'report-uri:https://o961321.ingest.sentry.io/api/5909725/security/?sentry_key=79a44fccebae470f8c022a0a6575562b',
